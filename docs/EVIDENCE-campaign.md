...
| T2 `emitN_sem` — the netlist normal form | ⛔ **BLOCKED** on the writer-slot ruling (see open ruling 5) — **the only remaining item in leg 2's theorem list** |
