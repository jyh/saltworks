...
masking. Record hits and misses in the campaign ledger (`docs/EVIDENCE-ledger-<date>.md`, generated by `docs/ledger-tools/nightly.sh`) either way. ⚠️ `docs/LEDGER.md` does NOT exist — an earlier draft of this brief sent executors to a file that was never created.
