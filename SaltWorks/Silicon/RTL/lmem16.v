// lmem16 — the LATCH-ARRAY rung of the memory ladder, 16 words x 32 bits.
//
// Council ruling, the Captain 09:0x: "let's probe the latch-ram, so we have a
// good ladder." This is the MIDDLE rung: flops (dmem16) -> LATCH ARRAY (here)
...
//
// ⚠️ ONE-VARIABLE PARITY WITH `dmem16.v`, deliberately — same interface, same
...
module lmem16 (
    ...
    input  wire [3:0]  addr,           // word address
