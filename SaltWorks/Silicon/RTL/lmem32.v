// lmem32 — the LATCH-ARRAY rung of the memory ladder, 32 words x 32 bits.
//
// Council ruling, the Captain 09:0x: "let's probe the latch-ram, so we have a
// good ladder." This is the MIDDLE rung: flops (dmem32) -> LATCH ARRAY (here)
...
//
// ⚠️ ONE-VARIABLE PARITY WITH `dmem32.v`, deliberately — same interface, same
...
module lmem32 (
    ...
    input  wire [4:0]  addr,           // word address
