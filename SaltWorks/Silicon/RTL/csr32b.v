...
module csr32b(clk, csr_addr, csr_op, csr_we, rs1_val, csr_rdata, csr_wdata_dbg);
    input         clk;
    input  [11:0] csr_addr;
    ...
    (* keep *) wire addr_match;              // the 8-bit page compare, NAMED
    assign addr_match = (csr_addr[11:4] == 8'h30);

    // ---- read: N-way select under a 12-bit address --------------------
    assign csr_rdata = addr_match ? csr[idx] : 32'b0;
